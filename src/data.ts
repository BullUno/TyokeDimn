import { ASSET_BASE, assetUrl } from "./lib/assetUrl";
...
const gallery = (dir: string, files: string[]) =>
  files.map((f) => `${ASSET_BASE}assets/works/${dir}/${f}`);
...
export const displayOf = (src: string) =>
  src.includes("/assets/works/") ? src.replace(/\.webp$/i, "-w2400.webp") : src;
...
/** FULL_SIZES 查找：URL 带 base 前缀（如 "./assets/..."）时先归一化为规范键 */
export const fullSizeOf = (src?: string) =>
  src ? FULL_SIZES[src.replace(ASSET_BASE, "/")] : undefined;
...
export const projects: Project[] = [
  {
    image: assetUrl("/assets/works/snc2/P_T_4473.webp"),
    label: "活动摄影",
  ...
  {
    image: assetUrl("/assets/works/melody/P_T_1693.webp"),
    label: "人像摄影",
  ...
  {
    image: assetUrl("/assets/works/cinematic/LAS_YC4.webp"),
    label: "写真",
  ...
  {
    image: assetUrl("/assets/works/kids/P_T_0316.webp"),
    label: "儿童摄影",
...
export const explorationVideos = {
  c4d: [
    { video: assetUrl("/assets/videos/c4d-1.mp4"), title: "循环动画" },
    { video: assetUrl("/assets/videos/c4d-2.mp4"), title: "柔体" },
    { video: assetUrl("/assets/videos/c4d-3.mp4"), title: "树枫红叶" },
  ],
  ae: [
    { video: assetUrl("/assets/videos/ae-1.mp4"), title: "5G城市" },
    { video: assetUrl("/assets/videos/ae-2.mp4"), title: "奥运会开幕" },
    { video: assetUrl("/assets/videos/ae-3.mp4"), title: "靖江诗文" },
  ],
};
...
export const journal: JournalEntry[] = [
  { video: assetUrl("/assets/videos/gov34.mp4"), poster: assetUrl("/assets/videos/gov34-poster.webp"), preview: assetUrl("/assets/videos/preview1.webp") },
  { video: assetUrl("/assets/videos/wo-nihao.mp4"), poster: assetUrl("/assets/videos/wo-nihao-poster.webp"), preview: assetUrl("/assets/videos/preview2.webp") },
  { video: assetUrl("/assets/videos/dengge.mp4"), poster: assetUrl("/assets/videos/dengge-poster.webp"), preview: assetUrl("/assets/videos/preview3.webp") },
];
