...
import { ALWAYS_PLAY_ANIMATIONS } from '../constants/motionPolicy';
...
const GhostFibers = ({
  ...
  useEffect(() => {
    ...
    const canAnimate = () => isVisible && isPageVisible && !isPaused && !(ALWAYS_PLAY_ANIMATIONS ? false : reducedMotion.matches);
