...
import { projects, thumbOf, midOf, fullSizeOf } from "../data";
          ...
          {projects.map((project, i) => (
            ...
            >
              <img
                ...
                srcSet={`${thumbOf(project.image)} 900w, ${midOf(project.image)} 1200w, ${project.image} ${fullSizeOf(project.image)?.w ?? 3000}w`}
